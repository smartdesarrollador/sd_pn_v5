"""
AreaSearchBar Widget for Widget Sidebar
...
class AreaSearchBar(QWidget):
    """
    Search bar widget with debouncing for areas
    Emits search_changed signal after 300ms of user inactivity
    """

    search_changed = pyqtSignal(str)  # Emits search query

    def __init__(self, parent=None, placeholder: str = "Buscar elementos..."):
    ...
    def _apply_styles(self):
        """Apply dark theme styles with purple accent"""
        ...
        # Search input style with purple accent
        ...
        # Clear button style with purple accent
