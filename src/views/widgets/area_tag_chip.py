"""
Area Tag Chip Widget - Widget visual para mostrar un tag individual
...
class AreaTagChip(QWidget):
    ...
    def __init__(self, tag: AreaElementTag, removable: bool = True, parent=None):
        """
        Inicializa el chip
    ...
    def set_tag(self, tag: AreaElementTag):
        """
