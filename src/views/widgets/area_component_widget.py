"""
Area Component Widget - Widgets para componentes estructurales de áreas
...
class AreaComponentWidget(QWidget):
    """Widget base para componentes estructurales de áreas"""
    ...
    def __init__(self, component_data: dict, view_mode: str = 'edit', parent=None):
        """
        Args:
            component_data: Diccionario con datos del componente (id, area_id, component_type, content, order_index)
